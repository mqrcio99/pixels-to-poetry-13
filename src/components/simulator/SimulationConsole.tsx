...
export function SimulationConsole() {
  ...
  return (
    <div
      className="h-[200px] shrink-0 border-t-[2.5px] border-black"
    ...
    >
      ...
      <div ref={ref} className="h-[calc(200px-32px)] overflow-y-auto px-4 py-2 text-[12.5px]">
        {log.length === 0 && (
          <div className="opacity-60">
            Escolha uma carga e clique em ▶ Simular para disparar as requisições.
          </div>
        )}
        {log.map((l) => {
