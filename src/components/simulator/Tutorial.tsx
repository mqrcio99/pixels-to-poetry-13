  ...
  return (
    <>
      <button
        onClick={openAgain}
        title="Ver tutorial"
        className="flex items-center gap-1.5 rounded-full border-2 border-black bg-white px-3 py-1.5 text-[13px] font-bold shadow-[2px_2px_0_#000] hover:-translate-y-0.5 transition-transform"
