...
export function SimulationControls() {
  ...
  const btn =
    "flex items-center gap-1.5 rounded-full border-2 border-black bg-white px-3 py-1.5 text-[13px] font-bold shadow-[2px_2px_0_#000] transition-transform hover:-translate-y-0.5 disabled:opacity-40";
    ...
    >
      ...
      <label className="flex items-center gap-2 rounded-full border-2 border-black bg-white px-3 py-1 text-[13px] shadow-[2px_2px_0_#000]">
        ...
        <select
          ...
          className="rounded-md border border-black/30 bg-white px-1 py-0.5 text-[13px] font-bold"
      ...
      <label className="flex items-center gap-1 text-[13px]">
        ...
        <select
          className="rounded-full border-2 border-black bg-white px-2 py-0.5 text-[13px] font-bold shadow-[2px_2px_0_#000]"
          value={speed}
